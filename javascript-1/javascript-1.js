...
for (let i in lettersToPair) {
    for (z=i; z<lettersToPair.length; z++) {
        if (z!==i) {
            if (lettersToPair[i]===lettersToPair[z]) {
                pairsArray.push([Number.parseInt(i),z]);
            }; 
        };
    };
};
...
//CODE HERE
  let phone1 = new Phone('Samsung', 'Galaxy', 64, 'Black', false)
  
  let phone2 = new Phone('Samsung', 'Galaxy', 64, 'Black', false)
  
  let phone3 = new Phone('Samsung', 'Galaxy', 64, 'Black', false)
